...
func (od *OptsDriver) getDriverFunction(driverName string) (func(dcluster.MachineDescription) []string, bool) {
	...
	return method.Interface().(func(dcluster.MachineDescription) []string), true
}
